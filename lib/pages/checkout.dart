...
import 'package:staycation/widgets/overlay_loading.dart';
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Future _imgChoose(ImageSource source) async {
    try {
              ...
              child: Wrap(
                children: <Widget>[
                  ListTile(
                      ...
                      title: Text('Gallery'),
                      onTap: () {
                        _imgChoose(ImageSource.gallery);
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color:
                                Color(pageIndex >= 2 ? 0xFF1ABC9C : 0xFFFFFFFF),
                            border: Border.all(
                                color: Color(
                      ...
                      Container(
                        width: pageIndex == 3 ? 44 : 37,
                        height: pageIndex == 3 ? 44 : 37,
                        padding: EdgeInsets.all(pageIndex == 3 ? 4 : 0),
                        decoration: pageIndex == 3
                            ? BoxDecoration(
                                borderRadius: BorderRadius.circular(100),
                                color: Color(0xFF1ABC9C),
                                border: Border.all(color: Color(0xFF1ABC9C)))
                            : BoxDecoration(),
                        child: CircleAvatar(
                          foregroundColor: Color(0xFF898989),
                          backgroundColor:
                              Color(pageIndex == 3 ? 0xFF1ABC9C : 0xFFE5E5E5),
                          child: pageIndex == 3
                              ? Icon(Icons.check, color: Colors.white)
                              : Text(
                                  '2',
                          ...
                          children: [
                                                ...
                                                Text(
                                                    ...
                                                    style: TextStyle(
                                                        ...
                                                        color:
                                                            Color(0xFF152C5B))),
                                                Text(
                                                    'per $_dateCount Night${_dateCount > 1 ? 's' : ''}',
                                                    style: TextStyle(
                                                        fontSize: 10,
                                                        fontWeight:
                                                            FontWeight.w300,
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 21),
                                Image.asset(
                                    'assets/images/complete_checkout.png',
                                    width: 265,
                                    height: 242),
                                SizedBox(
                                  height: 14,
